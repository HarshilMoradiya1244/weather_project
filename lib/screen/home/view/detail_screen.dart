                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        Row(
                          children: [
                            const Text(" Surat",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                            IconButton(onPressed: (){}, icon: const Icon(Icons.book_outlined,color: Colors.black,)),
                        ...
                        Column(
                          children: [
                            ...
                            Text("${providerw!.weatherModel!.windModel!.speed} km/h")
                          ],
                        ),
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              const Text("Low pollen count",style: TextStyle(color: Colors.white),)
                            ],
                          ),
                        ),
